...
taua = 100;
taub1 = 10;
taub = taub1*(factb.^(0:D(2)-1));
wba = 1;

V = numel(FRETv);
FRET = [];
for v = 1:V
    FRET = cat(1,FRET,repmat([FRETv(v),wFRETv(v)],D(v),1));
end
FRET = repmat(FRET,1,1,N);
...
kb0 = 1./taub;
wbb = (1-wba)/D(2);
trans_rates = [	0           1/(D(2)*taua)	1/(D(2)*taua)   1/(D(2)*taua)	1/(D(2)*taua)
                wba*kb0(1)	0               wbb*kb0(1)      wbb*kb0(1)      wbb*kb0(1)
                wba*kb0(2)	wbb*kb0(2)      0               wbb*kb0(2)      wbb*kb0(2)
                wba*kb0(3)	wbb*kb0(3)      wbb*kb0(3)      0              wbb*kb0(3)
                wba*kb0(4)	wbb*kb0(4)      wbb*kb0(4)      wbb*kb0(4)      0];
trans_rates = repmat(trans_rates,1,1,N);
...
ini_prob = repmat(1/sum(D),[N,sum(D)]);
